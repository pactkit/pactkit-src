...
class TestR1NoGlobalOpencodeJson:
    """R1: pactkit init --format opencode should NOT generate opencode.json at global level."""

    def test_global_deploy_no_opencode_json(self, tmp_path):
        """opencode.json is NOT created in global deployment."""
